...
MemoryStore.prototype.getNodeData = function (_id, callback) {
    if (callback) callback(null, this._nodes[_id].getData());
};
...
MemoryStore.prototype.addEdge = function (nodeId1, nodeId2, callback) {
    ...
    node1._edges[nodeId2] = {connected: true, neighborId: nodeId1};
    node2._edges[nodeId1] = {connected: true, neighborId: nodeId2};
    if (callback) callback(null);
};
...
MemoryStore.prototype.addDirEdge = function (nodeId1, nodeId2, callback) {
    ...
    var node2 = this._nodes[nodeId2];
    node1._edges[nodeId2] = {connected: true, neighborId: nodeId1};
    node2._edges[nodeId1] = {connected: false, neighborId: nodeId2};
    if (callback) callback(null);
};
...
MemoryStore.prototype.removeAllEdges = function (nodeId, callback) {
    ...
    var _iter = function () {
        ...
        delete this._nodes[edge.neighborId]._edges[nodeId];
        setImmediate(_iter);
    }.bind(this);
    setImmediate(_iter);
};
